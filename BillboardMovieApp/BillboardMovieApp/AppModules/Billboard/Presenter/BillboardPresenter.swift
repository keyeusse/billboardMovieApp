...
class CatalogPresenter: CatalogPresenterProtocol {
  ...
  private let resultsTitle: String = "Searched results"
  ...
  private func customizeTextColorTo(control: inout UISegmentedControl) {
    let mainTextAtt = [NSAttributedString.Key.foregroundColor: UIColor.blue]
    let unselectedTextAtt = [NSAttributedString.Key.foregroundColor: UIColor.lightGray]
